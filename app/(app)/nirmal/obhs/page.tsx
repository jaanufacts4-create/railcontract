...
export default function NirmalOBHSPage() {
  ...
  async function load() {
    const r = await fetch('/api/nirmal/obhs')
  ...
  async function handleUpload(e: React.FormEvent) {
    ...
    try {
      const res = await fetch('/api/nirmal/obhs/upload', { method: 'POST', body: fd })
  ...
  return (
    <div style={{ maxWidth: 740 }}>
      <div style={{ marginBottom: 24 }}>
        <h1 style={{ fontSize: 20, fontWeight: 700, color: 'var(--text)', margin: 0 }}>OBHS Monthly Data — Nirmal</h1>
